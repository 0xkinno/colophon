/**
 * COLOPHON — Universal Deterministic SHA-256
 *
 * Pure TypeScript implementation of FIPS 180-4 SHA-256.
 * Zero external dependencies. Runs identically in Node.js, Next.js browser bundles, and Edge runtimes.
 * Resolves Webpack unhandled "node:crypto" scheme in client-side Next.js components.
 */
